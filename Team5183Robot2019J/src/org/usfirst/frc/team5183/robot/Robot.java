...
import org.usfirst.frc.team5183.robot.commands.ExampleCommand;
import org.usfirst.frc.team5183.robot.subsystems.ExampleSubsystem;
...
public class Robot extends TimedRobot {
	...
	public void robotInit() {
		m_oi = new OI();
		m_chooser.addDefault("Default Auton", new ExampleCommand());
		// m_chooser.addObject("Left Auton", new LeftAutonCommand());
		// m_chooser.addObject("Center Auton", new CenterAutonCommand());
		// m_chooser.addObject("Right Auton", new RightAutonCommand());
